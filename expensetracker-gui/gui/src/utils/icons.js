...
export const rent = <i className="fa-solid fa-house-chimney-user"></i>
export const groceries = <i className="fa-solid fa-basket-shopping"></i>
export const transportation = <i className="fa-solid fa-train-subway"></i>
